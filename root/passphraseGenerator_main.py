from source import passphraseGenerator_functions as passwordGenerator
...
def main():
    ...
    confirmation = input(
        "Please press [Enter] to acknowledge that you have read the instructions and desire to continue, or type 'q' to quit. "
    )
